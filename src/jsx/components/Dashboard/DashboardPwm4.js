...
const Home = () => {
	...
	useEffect(() => {
		...
		axios.get(url + 'data-terbaru/pm4').then((response) => {
			setDataTerbaru(response.data.data)
		})
		axios.get(url + 'data-harian/pm4').then((response) => {
	...
	const handleMingguan = () => {
		setLoading(true)
		axios.get(url + 'data-mingguan/pm4').then((response) => {
			setDataHistoryChart(response.data.data)
			setLoading(false)
	...
	const handleBulanan = () => {
		setLoading(true)
		axios.get(url + 'data-bulanan/pm4').then((response) => {
			setDataHistoryChart(response.data.data)
			setLoading(false)
